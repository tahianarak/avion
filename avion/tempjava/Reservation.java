...
public class Reservation {
    ...
    public int getIdEnfantAgeMax() {
        return idEnfantAgeMax;
    }

    public void setIdEnfantAgeMax(int idEnfantAgeMax) {
        this.idEnfantAgeMax = idEnfantAgeMax;
    }

    public AgeEnfantMaxRemise getAgeEnfantMaxRemise() {
        return ageEnfantMaxRemise;
    }

    public void setAgeEnfantMaxRemise(AgeEnfantMaxRemise ageEnfantMaxRemise) {
        this.ageEnfantMaxRemise = ageEnfantMaxRemise;
    }

    AgeEnfantMaxRemise ageEnfantMaxRemise;
    ...
    public static void insert(Connection connection, Reservation reservation)throws Exception {
        String query = "INSERT INTO reservation (date_reservation, id_user, id_vol, id_type_siege, prix_billet,nb_place,place_en_promotion,remise,prix_unitaire,photo_passport,nb_place_enfant,id_age_enfant_max) VALUES (?,?,?, ?, ?, ?, ?,?,?,?,?,?)";
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            preparedStatement.setInt(11,reservation.getPlaceEnfant());
            preparedStatement.setInt(12,reservation.getIdEnfantAgeMax());
